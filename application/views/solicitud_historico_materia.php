    ...
    <div class="container">
      <div class="row">
        ...
        <div class="span12">
          ...
          <p>En esta sección se permite acceder a un informe que contiene un resumen de las respuestas para una pregunta en más de un período, para una materia de una carrera en particular.</p>
        </div>
      </div>
      ...
      <div class="row">
        ...
        <div id="contenedor" class="span9">
          ...
          <ul class="nav nav-tabs">
            <li class="active"><a href="#">Histórico por asignatura</a></li>
          </ul>
