      ...
      <div class="row">
        ...
        <div id="contenedor" class="span9">
          ...
          <ul class="nav nav-tabs">
            <li><a href="<?php echo site_url('informes/departamento')?>">Informe por carrera</a></li>
          ...
          <form class="form-horizontal" action="<?php echo site_url('ranking/docentesDepartamento')?>" method="post">
