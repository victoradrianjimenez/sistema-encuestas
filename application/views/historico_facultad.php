...
<head>
  ...
  <title>Histórico por Facultad - <?php echo NOMBRE_SISTEMA?></title>
  <style>
...
<body>
  ...
  <div class="container">
    <div id="header" class="row">
      <div class="span12">
        <h2 class="text-center"><?php echo NOMBRE_UNIVERSIDAD?></h2>
        <h4 class="text-center"><?php echo NOMBRE_FACULTAD?></h4>
      </div>
    </div>
    <div class="row">
      <div class="span12">
