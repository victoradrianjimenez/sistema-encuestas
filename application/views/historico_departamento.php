...
<head>
  ...
  <title>Histórico por Departamento - <?php echo NOMBRE_SISTEMA?></title>
  <style>
...
<body>
  ...
  <div class="container">
    ...
    <div class="row">
      <div class="span12">
        <img src="<?php echo site_url('pCharts/graficoHistoricoDepartamento/'.
          $departamento->idDepartamento."/".$pregunta->idPregunta.'/'.$fechaInicio.'/'.$fechaFin)
